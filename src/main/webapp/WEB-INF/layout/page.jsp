...
<head>
    ...
    <meta name="description" content="헬스장">
    ...
    <div class="SideMenu isOpen CR__hidden--L">
        ...
        <div class="SideMenu__container">
            <div class="SideMenu__head">
                <div class="SideMenu__head--user">
                    <div class="top">
                        ...
                        <button id="close" style="border: none">
            ...
            <div class="SideMenu__menuWrapper">
                ...
                <security:authorize access="hasRole('ROLE_USER')">
                    <security:authentication var="users" property="principal"/>
                        <a class="SideMenu__menuEach" href="/cs/faq">문의 게시판</a>
                        <form name="logoutForm" method="post" action="/logout">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <button type="submit" class="SideMenu__menuEach" style="border: none">
